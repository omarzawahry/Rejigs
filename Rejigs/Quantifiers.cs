...
public partial class Rejigs
{
    ...
    /// <summary>
    ///     Appends a regex pattern that matches between the specified minimum and maximum number
    ///     of times.
    /// </summary>
    ...
    /// <summary>
    ///     Appends a regex pattern that matches zero or more occurrences of the specified
    ///     pattern.
    /// </summary>
    ...
    /// <summary>
    ///     Appends a regex pattern that matches one or more occurrences of the specified
    ///     pattern.
    /// </summary>
